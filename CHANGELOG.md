...
**同步修改（2026-08-22）：** `/api/health`、`/api/ready` 版本号 6.9 → 7.0；`docs/多模态落地改造清单.md` 勾选视频理解/移动端适配/演示脚本；`docs/功能验证清单.md` 增加录像旁听与窄屏验证记录；全量测试 291 → 293 → 295 passed；`app.js?v=` 内容哈希更新（3ebd7446 → b76c30b0）。
